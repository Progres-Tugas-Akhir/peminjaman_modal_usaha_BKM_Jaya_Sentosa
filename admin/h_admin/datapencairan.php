				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Data Pencairan Uang</li>
						</ul><!-- /.breadcrumb -->
							...
							<div class="col-xs-12 col-md-12 col-sm-12">
								<div class="col-sm-10 alert alert-info" style="padding-bottom:0px;">
										...
										<div class="form-group">
												<label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> Nama Anggota KSM </label>
											...
											<div class="form-group">
												<label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> Jumlah Pinjaman </label>
												<div class="col-sm-5">
													<textarea class="form-control" id="form-field-8" name="keterangan" placeholder="Masukkan Nominal Uang"></textarea>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> Angsuran ke </label>
												<div class="col-sm-2">
