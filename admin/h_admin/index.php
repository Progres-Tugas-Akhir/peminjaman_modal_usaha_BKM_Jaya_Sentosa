		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="sidebar-shortcuts" id="sidebar-shortcuts" style="background: #8ecff5; color:#013197; border: 3px solid #f2f2f2; padding: 5px;">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="index.php?datapengurus"><i class="menu-icon fa fa-user"></i><span class="menu-text">Pengurus Lembaga </span></a>
					</li>
					<li class="">
						<a href="index.php?dataanggota"><i class="menu-icon fa fa-users"></i><span class="menu-text"> Data Anggota KSM </span></a>
					</li>
					<li class="">
						<a href="index.php?datakeluarmasukuang"><i class="menu-icon fa fa-map"></i><span class="menu-text">Keluar Masuk Uang </span></a>
					</li>
					<li class="">
						<a href="index.php?datapembayaranangsuran"><i class="menu-icon fa fa-paypal"></i><span class="menu-text">Pembayaran</span></a>
					</li>
					<li class="">
						<a href="index.php?datapencairan"><i class="menu-icon fa fa-list"></i><span class="menu-text"> Data Pencairan Uang</span></a>
					</li>
					<li class="">
