...
if(isset($_POST['tambah'])){
		...
		$query3 = "INSERT INTO tb_pembayaran_angsuran (id_pembayaran,id_pencairan,id_anggota,kode_pembayaran,id_kode) VALUES ('$id_pembayaran','$id_pencairan','$id_anggota','$kode_pembayaran','$kid_kode')"; 

		if (mysqli_query($connect, $query3)){
		?>
			<script type="text/javascript">
				alert("Sukses insert Proyek");
			</script>
			<?php
			echo"<script>document.location='index.php?proyek'</script>";
        }
        else{ 
		?>
			<script type="text/javascript">
...
if(isset($_POST['ganti'])){
		...
		$owner = $_POST['owner'];
		$pemasar = $_POST['pemasar'];
		$keterangan = $_POST['keterangan'];

		$query3 = "UPDATE proyek set nama_proyek='$nama_proyek', owner='$owner', keterangan='$keterangan', pemasar='$pemasar' WHERE id_proyek='$id_proyek'"; 

		if (mysqli_query($connect, $query3)){
		?>
			<script type="text/javascript">
				alert("Sukses Update Master Proyek");
			</script>
			<?php
			echo"<script>document.location='index.php?proyek'</script>";
        }
...
if(isset($_POST['delete'])){
		...
		$query3 = "DELETE FROM proyek WHERE id_proyek='$id_proyek'"; 

		if (mysqli_query($connect, $query3)){
		?>
			<script type="text/javascript">
				alert("Sukses Delete Master Proyek");
			</script>
			<?php
			echo"<script>document.location='index.php?proyek'</script>";
        }
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Master Proyek</li>
						</ul><!-- /.breadcrumb -->
