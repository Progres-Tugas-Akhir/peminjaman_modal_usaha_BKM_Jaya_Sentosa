...
if(isset($_POST['tambah'])){
		...
		$query3 = "INSERT INTO tb_pengurus_lembaga (id_pengurus_lembaga,username,password,nama,alamat,notelp,level,foto) VALUES ('$id_pengurus_lembaga','$username','$password','$nama','$alamat','$notelp','$level','$foto')"; 
...
if(isset($_POST['ganti'])){
		...
		$query3 = "UPDATE tb_pengurus_lembaga set username='$username',password='$password',nama='$nama',alamat='$alamat',notelp='$notelp',level='$level',foto='$foto' WHERE id_pengurus_lembaga='$id_pengurus_lembaga'"; 
		if (mysqli_query($connect, $query3)){
		?>
			<script type="text/javascript">
