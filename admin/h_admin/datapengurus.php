...
if (isset($_POST['tambah'])) {
  ...
  $id_pengurus_lembaga=$_POST['$id_pengurus_lembaga'];
  ...
  if (!empty($_FILES)) {
    if ($size < 1000000000) {
      ...
      if (move_uploaded_file($tmp_name, $video)) {
        $query = mysqli_query($connect, "INSERT INTO tb_pengurus_lembaga (id_pengurus_lembaga,username,password,nama,alamat,notelp,jabatan,gambar) 
										VALUES ('$id_pengurus_lembaga','$username','$password','$nama','$alamat','$notelp','$jabatan','$baru')");
        if ($query) {
			?>
				<script type="text/javascript">
				alert("Sukses Tambah Data Pengurus Lembaga");
			</script>
			<?php
          echo "<script>document.location='index.php?datapengurus'</script>";
        }
      }
      else {
		 ?>
		<script type="text/javascript"> alert("Upload gambar gagal"); </script>
		<?php echo "<script>document.location='index.php?datapengurus'</script>";
      }
    }else {
		?>
...
if(isset($_POST['update'])){
	...
	$gambar=$_POST['gambar'];
		...
		$query3 = "UPDATE tb_pengurus_lembaga set nama='$nama',username='$username',password='$password',alamat='$alamat',notelp='$notelp',jabatan='$jabatan',gambar='$gambar' WHERE id_pengurus_lembaga='$id_pengurus_lembaga'"; 

		if (mysqli_query($connect, $query3)){
		?>
			<script type="text/javascript">
				alert("Sukses Update Data Pengurus Lembaga");
			</script>
			<?php
			echo "<script>document.location='index.php?datapengurus'</script>";
        }
	...
	if(isset($_POST['delete'])){
		...
		$query3 = "DELETE FROM tb_pengurus_lembaga WHERE id_pengurus_lembaga='$id_pengurus_lembaga'";

		if (mysqli_query($connect, $query3)){
		?>
			<script type="text/javascript">
				alert("Sukses Delete Data Pengurus Lembaga");
			</script>
			<?php
			echo "<script>document.location='index.php?datapengurus'</script>";
        }
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Data Pengurus Lembaga BKM Jaya Sentosa</li>
						</ul><!-- /.breadcrumb -->
							...
							<div class="col-xs-12 col-md-12 col-sm-12">
								<div class="col-sm-10 alert alert-info" style="padding-bottom:0px;">
										...
										<div class="form-group">
                                                ...
                                                <div class="col-sm-2">
													<input type="text" name="nama" id="form-field-1-1"  />
												</div>
											<div class="form-group">
												<label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> Alamat </label>
												<div class="col-sm-5">
													<textarea class="form-control" id="form-field-8" name="alamat" placeholder="Masukkan Alamat"></textarea>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> Username </label>
												<div class="col-sm-2">
													<input type="text" name="username" id="form-field-1-1"  />
												</div>
											
												<label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> Password </label>
												<div class="col-sm-2">
													<input type="text" name="password" id="form-field-1-1"  />
												</div>
											</div>
                                            <div class="form-group">
												<label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> No Telepon </label>
												<div class="col-sm-2">
												...
												<tbody>
													...
													while ($data = mysqli_fetch_array($sql)) { ?>
														<tr>
															...
															<td><?php echo substr($data['alamat'], 0,25)." ...";?></td>
                                                            <td><?php echo $data['notelp']; ?></td>
															<td><?php echo $data['jabatan']; ?></td>
															<td><img src="../upload/<?php echo $data['gambar'];?>" width="100" height="150" ></td>

															<td style="text-align: center;">
																<div class="hidden-sm hidden-xs action-buttons">
																	<a href="#modal-edit<?php echo $data['id_pengurus_lembaga']; ?>" role="button" class="green" data-toggle="modal">
...
<<<<<<< HEAD
													...
													<!-- Edit modal -->
													<div id="modal-edit<?php echo $data['id_pengurus_lembaga']; ?>" class="modal fade" tabindex="-1">
															...
															<div class="modal-body">
																	<div class="form-group">
																		...
																		<div class="col-xs-12 col-sm-9">
																			<input type="hidden" name="id_pengurus_lembaga" value="<?php echo $data['id_pengurus_lembaga']; ?>" />
																	...
																	<div class="form-group">
																		...
																		<div class="col-xs-12 col-sm-9">
																			<input type="text" name="username" class="col-xs-12 col-sm-12" value="<?php echo $data['username']; ?>" required="" />
																		</div>
																	</div>
																	<div class="space-6"></div><div class="space-6"></div><div class="space-6"></div><div class="space-4"></div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																		...
																		<div class="col-xs-12 col-sm-9">
																			<input type="text" name="notelp" class="col-xs-12 col-sm-12" value="<?php echo $data['notelp']; ?>" required="" />
																		</div>
																	</div>
																	<div class="space-6"></div><div class="space-6"></div><div class="space-6"></div><div class="space-4"></div>
																	<div class="form-group">
																		...
																		<div class="col-xs-12 col-sm-9">
																			<input type="text" name="jabatan" class="col-xs-12 col-sm-12" value="<?php echo $data['jabatan']; ?>" required="" />
																		</div>
																	</div>
																	<div class="space-6"></div><div class="space-6"></div><div class="space-6"></div><div class="space-4"></div>
																		<div class="form-group">
													...
													<!-- delete modal -->
												<!-- delete modal -->
												<div id="modal-delete<?php echo $data['id_pengurus_lembaga']; ?>" class="modal fade" tabindex="-1">
													<div class="modal-dialog" >
														<div class="modal-content">
															<div class="modal-header no-padding red">
																<div class="table-header" style="background-color: red;">
																	...
																	Delete Data Pengurus Lembaga "<?php echo $data['id_pengurus_lembaga'] . " " . $data['nama_nama']; ?>"
																</div>
															</div>
															<form class="form-horizontal" role="form" form action="" method="post" enctype="multipart/form-data">
															<div class="modal-body">
																<label class="col-sm-12 control-label " style="color: red;">Apakah Anda yakin akan menghapus data pengurus ? "<?php echo $data['id_pengurus_lembaga']; ?> - <?php echo $data['nama']; ?>"</label>
																<input type="hidden" name="id_pengurus_lembaga" value="<?php echo $data['id_pengurus_lembaga']; ?>" />	
