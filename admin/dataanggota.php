...
include "../k.php";
	...
	if(isset($_POST['on'])){
		...
		$query3 = "UPDATE dokumen set status_dokumen=1 WHERE id_proyek='$id_proyek'"; 
	...
	if(isset($_POST['off'])){
		$id_survey=$_POST['id_survey'];
		$query3 = "UPDATE dokumen set status_dokumen=0 WHERE id_proyek='$id_proyek'"; 
